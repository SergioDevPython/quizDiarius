...
st.title('Formulário de Perguntas - Diarius Check' )
...
st.subheader('1. O aplicativo Diário Check permite registrar a entrada de estudantes através da leitura das carteirinhas.')
